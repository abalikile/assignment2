...
function ProductRow(props) {
  const product = props.product; // Appending the '$' symbol to the price value.

  const display$ = '$' + product.price;
  return React.createElement("tr", null, React.createElement("td", null, product.productname), React.createElement("td", null, display$), React.createElement("td", null, product.category), React.createElement("td", null, React.createElement("a", {
    href: product.image,
    target: "_blank"
  }, "View")));
}
...
class ProductAdd extends React.Component {
  ...
  render() {
    return React.createElement("form", {
      ...
      name: "category"
    }, React.createElement("option", null, "Shirts"), React.createElement("option", null, "Jeans"), React.createElement("option", null, "Jackets"), React.createElement("option", null, "Sweaters"), React.createElement("option", null, "Acessories"))), React.createElement("div", {
      className: "fleft"
    }, React.createElement("label", {
      for: "price"
      ...
      for: "productname"
    }, "ProductName"), React.createElement("br", null), React.createElement("input", {
      type: "text",
      name: "productname"
    })), React.createElement("div", {
      className: "fleft"
...
class ProductList extends React.Component {
  ...
  createProduct(product) {
    ...
    newProductList.push(product); //setState() method triggers UI updates
